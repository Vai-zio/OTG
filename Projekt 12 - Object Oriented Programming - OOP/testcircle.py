from circle import Circle, Circle2
import pygame as pg
import sys
import random
import math
...
c1 = Circle(100,200,20)
c2 = Circle(100,130,60)


circles = []
for i in range(20):
    c = Circle(random.randint(200,300),random.randint(100,500),random.randint(3,10),)
    circles.append(c)

circles2 = []
for i in range(random.randint(10,15)):
    c2 = Circle2(random.randint(200,300),random.randint(100,500),random.randint(3,10))
    circles2.append(c2)
    ...
    if state == "START":
        ...
        for c in circles:
            if c.collide(c):
                c1.r += c.r
                circles.remove(c)
                c = Circle(random.randint(100,700),random.randint(100,500),5)
                circles.append(c)
        ...
        for c2 in circles2:
            if c1.collide(c):
                c1.r += c.r
                circles2.remove(c)
                c = Circle(random.randint(100,700),random.randint(100,500),10)
                circles2.append(c)
